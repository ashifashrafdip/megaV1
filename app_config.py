...
class AppConfig:
    ...
    def load(cls, config_file: str | Path = CONFIG_FILE) -> "AppConfig":
        ...
        return cls(
            browser_engine=str(raw.get("browser_engine", "multilogin")).lower(),
    ...
    def with_browser_engine(self, browser_engine: str) -> "AppConfig":
        return AppConfig(
            ...
            multilogin=self.multilogin,
            proxy=self.proxy,
            adspower=self.adspower,
            user_agent=self.user_agent,
            window_size=self.window_size,
            camera_output_size=self.camera_output_size,
    ...
    def with_device_profile(self, device_profile_id: str) -> "AppConfig":
        return AppConfig(
            browser_engine=self.browser_engine,
            multilogin=self.multilogin,
            proxy=self.proxy,
            ...
            target_url=self.target_url,
            timeouts=self.timeouts,
            profile_name=device_profile_id or self.profile_name,
